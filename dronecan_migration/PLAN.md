...
| **P4** Vertical slice | GNSS + battery + ESC + DNA + SD-FW on `ark_fmu-v6x`, behind `DRIVERS_DRONECAN` | interactive backbone + `/dronecan-flash-delta` → PR | 🔒 slice proven | ⏳ P4.0 |
